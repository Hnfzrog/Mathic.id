...
- `help` → `.gemini/commands/eha-help.toml`
- `bootstrap` → `.gemini/commands/eha-bootstrap.toml`
- `refresh` → `.gemini/commands/eha-refresh.toml`
- `discuss` → `.gemini/commands/eha-discuss.toml`
- `sdd-execute` → `.gemini/commands/eha-sdd-execute.toml`
<!-- EHA:END -->
